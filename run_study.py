...
def main() -> None:
    ...
    print(f"Canonical figure scripts: {REPO_ROOT / 'figure_scripts'}", flush=True)
    print(f"Run all canonical figures with: bash {REPO_ROOT / 'figure_scripts' / 'run_all_figures.sh'}", flush=True)
