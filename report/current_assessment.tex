...
The corresponding MDL nuisance sweep shows a similar qualitative collapse pattern in intersection and no rescue in rack aisle, but the expected-order table above is the more defensible causal view because it isolates clutter effects from model-order error.
