...
This follow-on eigengap check is useful mainly as a robustness note, not as a replacement evidence base for the project. It was run only at the nominal point, whereas the regime map and nuisance conclusions still come from the saved sweep bundle. Its value is narrower: it shows that blind order selection can be improved somewhat in the favorable scenes, but it does not change the broader conclusion that clutter-dominated rack aisle remains outside the useful operating regime.
